...
import com.android.datetimepicker.date.DatePickerFragment.OnDateChangedListener_fragment;
...
public abstract class DayPickerView extends ListView implements OnScrollListener,
        OnDateChangedListener_fragment {
    ...
    private DatePickerController_fragment mController;
    ...
    public DayPickerView(Context context, DatePickerController_fragment controller) {
        super(context);
        init(context);
        setController(controller);
    }

    public void setController(DatePickerController_fragment controller) {
    ...
    public abstract MonthAdapter createMonthAdapter(Context context,
            DatePickerController_fragment controller);
