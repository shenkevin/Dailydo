 ...
 */
public class YearPickerView extends ListView implements OnItemClickListener, OnDateChangedListener_fragment {
    private static final String TAG = "YearPickerView";

    private final DatePickerController_fragment mController;
     ...
     * @param context
     */
    public YearPickerView(Context context, DatePickerController_fragment controller) {
        super(context);
