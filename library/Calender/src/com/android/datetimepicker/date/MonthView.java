...
public abstract class MonthView extends View {
    ...
    protected DatePickerController_fragment mController;
    ...
    public MonthView(Context context, AttributeSet attr) {
        ...
        mDayTextColor = res.getColor(R.color.my_blue);
        mTodayNumberColor = res.getColor(R.color.blue);
        mDisabledDayTextColor = res.getColor(R.color.date_picker_text_disabled);
        mMonthTitleColor = res.getColor(R.color.my_blue);
    ...
    public void setDatePickerController(DatePickerController_fragment controller) {
    ...
    protected void initView() {
        ...
        mMonthTitlePaint.setTypeface(TypeFaces.getTypeFace(getContext().getApplicationContext(),
                "fonts/mytype.ttf"));
        ...
        mMonthDayLabelPaint.setTypeface(TypeFaces.getTypeFace(getContext().getApplicationContext(),
                "fonts/mytype.ttf"));
