...
public class GifAnimationMetaData implements Serializable, Parcelable {
     ...
     * Convenience wrapper for {@link pl.droidsonroids.gif.GifAnimationMetaData#GifAnimationMetaData(java.io.FileDescriptor)}
     *
     * @param afd source
    ...
    /**
     * Retrieves metadata from {@link java.nio.ByteBuffer}. Only direct buffers are supported.
